...
void br_eval_Liveness(const char *predicted_xml, const char *gt_property, const char *distribution_property )
{
    EvalLiveness(predicted_xml, gt_property, distribution_property);
}
