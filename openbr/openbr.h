...
/*!
  ...
  * \note \ref input_string_buffer
  */
BR_EXPORT int br_get_filename(br_template tmpl, char * buffer, int buffer_length);
/*!
...
/*!
  ...
  * \note \ref input_string_buffer
  */
BR_EXPORT int br_get_metadata_string(br_template, const char *key, char * buffer, int buffer_length);
/*!
