...
void br::Context::initialize(int &argc, char *argv[], QString sdkPath, bool gui)
{
...
#ifndef BR_EMBEDDED
        application = gui ? new QApplication(argc, argv) : new QCoreApplication(argc, argv);
#else
        application = new QCoreApplication(argc, argv); (void) gui;
#endif
    }
