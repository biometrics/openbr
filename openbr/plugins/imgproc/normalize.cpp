 ...
 * \property enum NormType Values are NORM_INF, NORM_L1, NORM_L2, NORM_MINMAX
 * \property bool ByRow If true normalize each row independently otherwise normalize the entire matrix.
 * \property int alpha Lower bound if using NORM_MINMAX. Value to normalize to otherwise.
 * \property int beta Upper bound if using NORM_MINMAX. Not used otherwise.
 * \property bool squareRoot If true compute the signed square root of the output after normalization.
 */
