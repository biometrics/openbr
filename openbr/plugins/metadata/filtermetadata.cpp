 ...
 * @param[in] key1,key2 The meta-data key(s) to filter on
 * @param[in] value1,value2 The values to compare the values of key1 and key2 entires against
 * @param[in] compareType1 The comparison operation to perform. "le" ->  val(key1) <= value1, "lt" -> val(key1) < value1,
