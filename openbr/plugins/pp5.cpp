...
class PP5Initializer : public Initializer
{
    ...
    void initialize() const
    {
        ...
        Globals->abbreviations.insert("PP5Register", "Open+PP5Enroll(true,true,0.05,5,Frontal,4)+RenameFirst([eyeL,PP5_Landmark0_Right_Eye],Affine_0)+RenameFirst([eyeR,PP5_Landmark1_Left_Eye],Affine_1)");
