...
def init_brpy(br_loc='/usr/local/lib'):
    ...
    br.br_most_recent_message.restype = c_char_p
    br.br_objects.argtypes = _string_args(2) + [c_bool]
    br.br_objects.restype = c_char_p
    ...
    br.br_scratch_path.restype = c_char_p
    ...
    br.br_get_filename.argtypes = [c_void_p]
    br.br_get_filename.restype = c_char_p
    br.br_set_filename.argtypes = [c_void_p, c_char_p]
    br.br_get_metadata_string.argtypes = [c_void_p, c_char_p]
    br.br_get_metadata_string.restype = c_char_p
