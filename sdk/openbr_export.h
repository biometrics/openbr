...
#    endif
#  endif
# if defined BR_LIBRARY_GUI
#    if defined _WIN32 || defined __CYGWIN__
#      define BR_EXPORT_GUI __declspec(dllexport)
#    else
#      define BR_EXPORT_GUI __attribute__((visibility("default")))
#    endif
#  else
#    if defined _WIN32 || defined __CYGWIN__
#      define BR_EXPORT_GUI __declspec(dllimport)
#    else
#      define BR_EXPORT_GUI
#    endif
#  endif
#endif
