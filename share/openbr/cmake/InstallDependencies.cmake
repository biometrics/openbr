...
# Stasm
function(install_stasm_libs)
  if(${BR_INSTALL_DEPENDENCIES})
    set(lib stasm)
    if(WIN32)
      file(GLOB OpenBR_LIBS "${OpenBR_DIR}/lib/*.dll")
      install(FILES ${OpenBR_DIR}/bin/openbr.dll DESTINATION bin)
      install(FILES ${OpenBR_LIBS} DESTINATION bin)
    else()
      install(FILES ${Stasm_DIR}/build/lib${lib}${CMAKE_SHARED_LIBRARY_SUFFIX} DESTINATION lib)
    endif()
  endif()
endfunction()
