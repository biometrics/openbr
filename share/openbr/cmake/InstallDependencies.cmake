...
function(install_qt_misc)
  if(MSVC)
	...
	install(FILES ${_qt5Core_install_prefix}/bin/icuuc49${BR_INSTALL_DEPENDENCIES_SUFFIX}.dll DESTINATION bin)
	install(FILES ${_qt5Core_install_prefix}/bin/icudt49.dll DESTINATION bin)
	install(FILES ${_qt5Core_install_prefix}/bin/d3dcompiler_46.dll DESTINATION bin)
